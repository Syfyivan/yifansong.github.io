...
date: 2026-04-12 16:12:00
tags: [AI, 多智能体, Anthropic, 协作模式]
categories: [技术翻译]
---

> 本文整理自宝玉（@dotey）在 X 上的分享。
> [原文链接](https://x.com/dotey/status/2043240706156728322)

我们常常看到，有些团队在挑选模式时，只顾着选听起来“高大上”的，却忽略了到底适不适合手头的问题。我们的建议是：从最简单的、能跑通的模式开始，观察它在哪里会遇到瓶颈，然后再逐步升级。

今天这篇文章，我们就来拆解五种常见模式的运作原理和局限性：
...
![Generator-verifier](https://pbs.twimg.com/media/HFsLvvrXIAAOM3R?format=jpg&name=small)
...
想象一个用来回复客户工单的自动邮件系统。生成者利用产品文档 and 工单详情写出一封初稿。验证者则充当“质检员”：核对知识库看事实准不准、检查语气符不符合品牌要求、确认客户提到的每个问题是不是都回答了。如果检查没通过，验证者会把具体问题甩回给生成者，比如指出“把某个功能错误地归到了低配版里”或者“漏答了某个问题”。
...
![Orchestrator-subagent](https://pbs.twimg.com/media/HFsLy4uW0AAsfPO?format=jpg&name=small)
...
![Agent teams](https://pbs.twimg.com/media/HFsL2FJWIAAbOUS?format=jpg&name=small)
...
![Message bus](https://pbs.twimg.com/media/HFsL5QiakAA3HjQ?format=jpg&name=small)
...
![Shared state](https://pbs.twimg.com/media/HFsL8bJXIAAEhMK?format=jpg&name=small)
...
选哪种模式，取决于你对系统的几个核心结构问题的判断。我们提倡 **围绕“上下文”来拆解工作（Context-centric decomposition）**，即按照每个智能体“需要知道哪些背景信息”来分工，而不是按“它干什么类型的活”来分工。这五种模式最大的区别，就在于它们如何划分上下文的边界，以及如何管理信息的流动。

#### 调度 - 子智能体 vs. 智能体团队

![Compare 1](https://pbs.twimg.com/media/HFsL_piWoAAJmf4?format=jpg&name=small)
...
![Compare 2](https://pbs.twimg.com/media/HFsMClsbMAA-JjI?format=jpg&name=small)
...
![Compare 3](https://pbs.twimg.com/media/HFsMFzxXoAAh1WH?format=jpg&name=small)
...
![Compare 4](https://pbs.twimg.com/media/HFsMJBcWAAE5Kr3?format=jpg&name=small)
...
> **致谢**：本文由 Cara Phillips 撰写，Eugene Yang, Jiri De Jonghe, Samuel Weller 以及 Erik Schluntz 亦有贡献。
